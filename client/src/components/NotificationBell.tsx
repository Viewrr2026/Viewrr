...
export default function NotificationBell() {
  ...
  return (
    ...
    <div className="relative" ref={panelRef}>
      ...
      {/* Portalled modals — rendered into document.body so backdrop-blur on
          the navbar (which creates a new containing block) can never clip or
          offset these fixed-position overlays on any device or browser. */}
      {createPortal(
        <QuickMessageModal
          open={msgModal.open}
